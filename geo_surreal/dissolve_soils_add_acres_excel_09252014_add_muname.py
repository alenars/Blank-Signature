...
#A. Stephens
#09/25/2014
#Updated 11/19/2014 ~ add a try statement
...
try:
    fieldnom = "muname"
    fieldname = (arcpy.ValidateFieldName(fieldnom, os.path.dirname(inFC))

    if len (arcpy.ListFields(inFC, "muname", "All")) > 2

    else:
        raise FieldError

except FieldError:
        print "Input doesn't contain MUNAME"
