...
inFC2 = arcpy.GetParameterAsText(0)
inFC = arcpy.GetParameterAsText(1)
#outFC = arcpy.GetParameterAsText(1)
#outFCDISSOLVE = arcpy.GetParameterAsText(2)

#Make Feature Layer from Union soils
arcpy.MakeFeatureLayer_management(inFC2, "inFC2_lyr")

#Select 'Editor_Field'
arcpy.SelectLayerByAttribute_management("inFC2_lyr", "NEW_SELECTION", ' "Editor_Field" LIKE % ')

#Copy Features
arcpy.CopyFeatures_management ("inFC2_lyr", "outedfFC")

#Union update soils and original soils
arcpy.Union_analysis(["outedfFC",inFC], "union_compare_data", "ALL")
